	...
	<view class="order_detail">
		<view class="top">
			<view :style="'padding-top:'+barHeight" class="mar-lr-30">
				<view class="f-34 color-fff mar-t-60" >订单未支付</view>
				<view class="f-24 color-fff mar-t-20">订单编号：202104302147079077</view>
			</view>
		</view>
		<view class="order_info">
			<view class="flex-center flex-lr pad-tb-20 border_bottom">
				<view class="flex-center">
					<image src="../../static/img/avatar.jpg" mode="aspectFill" class="avatar_js"></image>
					<text class="f-26 color-1 mar-l-10">大陈村</text>
				</view>
				<text class="f-26 color-orange">进行中</text>
			</view>
			<view class="flex-center flex-lr pad-tb-20 border_bottom">
				<image src="../../static/img/avatar.jpg" mode="aspectFill" class="case_img"></image>
				<view class="flex-grow mar-l-20 color-1">
					<view class="f-28">水之春-中式按摩理疗</view>
					<view class="f-26  mar-t-10">时长：60分钟</view>
		...
		<view class="order_info2 color-1">
			...
			<image class="wx_code" src="../../static/img/avatar.jpg"></image>
